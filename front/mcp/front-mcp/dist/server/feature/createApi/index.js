...
function parseSwaggerResponse(swaggerResult) {
...
export async function handleCreateApiTool(request) {
    ...
    const responseList = await Promise.all(argsList.map(async (args) => {
